...
int movimentos[4][2] = {
    {-1, -1}, // esquerda em cima
    {-1,  1}, // esquerda embaixo
    { 1, -1}, // direita em cima
    { 1,  1} // direita embaixo
};
        ...
        for(int j = 0; j < tabuleiro->M; j++){
            ...
            while (topo > 0){
                ...
                for(int d = 0; d < 4; d++){
                    ...
                    if (lerValorCasa(atual.copiaEstado, tabuleiro->N, tabuleiro->M, saltoLinha, saltoColuna) == 2 && lerValorCasa(atual.copiaEstado, tabuleiro->N, tabuleiro->M, novoLinha, novoColuna) == 0){ 
